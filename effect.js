...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#b10,#b13,#b12').stop();
			...
			$('#b133').animate({top:240, left: vw+450},500);
			$('#b122').animate({top:240, left: vw+550},500);
		});
	...
	function loop11() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#b13').animate({left:randleft,bottom:randtop},8000,function(){
			loop11();
		});
	}
	function loop12() {
	...
	$('#balloons_flying').click(function(){
		...
		$('#b1,#b4,#b5,#b9').addClass('balloons-rotate-behaviour-one');
		$('#b2,#b3,#b6,#b8,#b10,#b12,#b7,#b13').addClass('balloons-rotate-behaviour-two');
